...
public class Orders implements Serializable {
	...
	public static Integer getPendingPayment() {
		return PENDING_PAYMENT;
	}

	public static Integer getToBeConfirmed() {
		return TO_BE_CONFIRMED;
	}

	public static Integer getConfirmed() {
		return CONFIRMED;
	}

	public static Integer getDeliveryInProgress() {
	...
	public static Integer getCancelled() {
		return CANCELLED;
	}

	public static Integer getUnPaid() {
		return UN_PAID;
	}
	...
	public static Integer getRefund() {
		return REFUND;
	}
